...
@testset "CairoMakie fig-formats" begin
    s = read(joinpath(@__DIR__, "../../examples/integrations/CairoMakieFigFormat.qmd"), String)
    ...
    not_showable_mimes(::Union{Val{:png}, Val{:jpeg}, Val{:retina}}) = showable_mimes(Val(:pdf))
