...
> If you are working with [Quarto Projects](https://quarto.org/docs/projects/quarto-projects.html), be aware that Quarto is failing to set a project-wide engine other than Python. A simple workaround is to set the Julia engine in each Quarto Markdown file of your project.
